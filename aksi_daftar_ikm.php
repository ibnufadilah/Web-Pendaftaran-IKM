...
$insert = mysqli_query($koneksi,"INSERT into ikm Values('$newID','$id_user','$nama_ikm','$penanggung_jawab','$alamat','$jenis_produksi','$bahan_baku','$tahun','$nama_file','$file_nib','$file_siup_iui','Data Menunggu Konfirmasi')");

if($insert){
	echo '<script>alert("Berhasil Register!"); document.location="pendaftaran_ikm.php";</script>';
}else{
	echo '<script>alert("Gagal Upload!"); document.location="pendaftaran_ikm.php";</script>';
}
